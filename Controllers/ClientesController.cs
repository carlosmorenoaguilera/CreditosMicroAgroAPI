...
namespace CreditosMicroAgroAPI.Controllers
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerDefaults.AuthenticationScheme, Roles = "empleado")]

    public class ClientesController : ControllerBase
    {
        private readonly CreditosMicroAgroContext _context;

        public ClientesController(CreditosMicroAgroContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Client>> PostCliente(Client cliente)
        {
          if (_context.Clientes == null)
          {
              return Problem("Entity set 'CreditosMicroAgroContext.Clientes'  is null.");
          }
